...
<style>
    body {
            background: url('image/reg.jpg') no-repeat fixed;
...
<body>
        ...
        <div class="w3-container">
            <div class="w3-container w3-card w3-white" style="max-width:700px;margin:auto;margin-top:10vh;margin-bottom:10vh;">
                <form class="w3-container w3-padding w3-margin" action="register.php"
                    ...
                    <br>
                    <div class="w3-center">
                        <input class="w3-button w3-round w3-grey" type="submit" name="submit" value="Submit">
                        <a href="login.php" class="w3-button w3-round w3-grey">Cancel</a>
                    </div>
    ...
    <footer>
        <p style="font-family: 'Oswald';text-align:center">Copyright HealWell Clinic &copy</p>
    </footer>
</body>
